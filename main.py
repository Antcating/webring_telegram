...
main_menu.row('➕ Add channel', '➖ Remove channel')
main_menu.row('◻️ List channels', '✔️ Update config')
...
Welcome to <b>Telegram Web Ring Control Bot!</b>
Use /admin_help to get information about usage.""", parse_mode='HTML', reply_markup=main_menu)
...
/list - get list of the channels.''', reply_markup=main_menu)
...
def reply_handler(message):
    if message.text == '➕ Add channel':
        channel_add(message)
    elif message.text == '➖ Remove channel':
        channel_delete(message)
    elif message.text == '◻️ List channels':
        list_channels(message)
    elif message.text == '✔️ Update config':
